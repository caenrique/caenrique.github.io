...
// const copyIcon2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="bi bi-clipboard" viewBox="0 0 16 16">
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  document.querySelectorAll('pre code').forEach(codeBlock => {
    ...
    const langClass = codeBlock.getAttribute("data-lang")
    const lang = langClass ? langClass : 'default';
